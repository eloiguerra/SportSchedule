...
<html lang = "en">
    <head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrOLViOEcD853xRHXT2_fBZ3VSK4ZVkoc&callback=getLocation"
    async defer></script>
                ...
                <div class = "divLoginUser">
                    <form class = "" id = "formLoginUser">
                        ...
                        <div class = "form-footer column">   
                            ...
                            <p class = "link" id = "forgotKey"> Esqueceu algum dado ? </p>
                        </div>
                    </form>
                </div>     
            </section>
